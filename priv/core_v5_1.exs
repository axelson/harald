[
  ...
  command_groups: [
    %{
      ...
      commands: [
        %{
          ...
          parameters: [],
          return: [
            %{name: "Status", type: {:branch, :error_codes}},
    ...
    #       id: 12,
    #       parameters: [
    #         %{name: "LE_Scan_Enable", size: 8},
    #         %{name: "Filter_Duplicates", size: 8}
    #       ],
  ...
  events: [
    %{
      ...
      parameters: [
        ...
        %{name: "Command_Opcode", type: {:branch, :op_codes}},
        %{name: "Return_Parameter(s)", type: {:parameters, [:returns, {:look_behind, 1}]}}
      ]
    }
    # %{
    #   name: "HCI_LE_Meta",
    ...
    #       parameters: [
    #         %{name: "Subevent_Code", value: 2, size: 8, type: :integer},
